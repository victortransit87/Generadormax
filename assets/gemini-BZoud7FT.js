import{G as g}from"./index-CfNfz5Q-.js";const I=async(n,s,r=null,o=10)=>{if(!n)throw new Error("API Key is required");const t=new g(n);t.getGenerativeModel({model:"gemini-1.5-flash"});const c=`
